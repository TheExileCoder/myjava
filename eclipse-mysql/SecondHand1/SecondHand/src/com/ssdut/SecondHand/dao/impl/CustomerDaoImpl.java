...
public class CustomerDaoImpl extends BaseDao implements CustomerDao{
	...
	private ResultSet rs = null; // 用户保存查询到的司机结果集
	/**
	 * @Description TODO 得到包含所有司机基本信息的泛型集合
	 * @param 
	 * @return List<Driver>
	 */
	@Override
	...
	/**
	 * @Description TODO 更新司机表的信息(包括增、删、改，没有查)
	...
	/**
	 * @Description TODO 根据查询条件得到某一个司机
	 * @param sql 预编译的 SQL 语句
	 * @param param 预编译的 SQL 语句中的‘？’参数的字符串数组
	 * @return Driver
	 */
	...
	public Customer getOneCustomer(String sql, Object[] param) {
		...
		while (rs.next()) {//把查询到的司机的基本信息赋值给即将返回的driver
